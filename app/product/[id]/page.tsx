    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
        ...
        <div className="space-y-6">
            ...
            <div className="border-t pt-6">
              ...
              <dl className="grid grid-cols-2 gap-3 text-sm">
                ...
                {details.sizes && details.sizes.length > 0 && (
                  <>
                    <dt className="font-medium text-muted-foreground">Sizes</dt>
          ...
          {/* زر Place Order المعدل */}
          <Button
            onClick={() => setModalOpen(true)}
            className="mt-4 w-full md:w-auto py-6 px-6 bg-gradient-to-r from-blue-400 to-blue-500 hover:from-blue-500 hover:to-blue-600 text-white shadow-lg transition-all"
          >
            📞 Place Order
          </Button>
        </div>
